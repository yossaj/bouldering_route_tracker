...
class MainActivity : AppCompatActivity(), RouteAdapter.ItemClickListener {
    ...
    override fun onOptionsItemSelected(item: MenuItem): Boolean {
        val id = item.itemId
        if (id == R.id.add) {
            val addNewRoute = Intent(this@MainActivity, AddRouteActivity::class.java)
    ...
    override fun onItemClickListener(itemId: Int) {
        val intent = Intent(this@MainActivity, AddRouteActivity::class.java)
    ...
    fun signOut() {
        if (mAuth!!.currentUser != null) {
            ...
            mAuth.signOut()
            val returnToSignIn = Intent(this@MainActivity, LoginActivty::class.java)
